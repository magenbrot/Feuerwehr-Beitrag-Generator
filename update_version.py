"""Erhöht die Versionsnummer in der packages.json nach dem Schema YYYY.MM.PATCH."""
import json
import datetime
import os
import subprocess
...
def main():
    ...
    commands_to_run = [
        ...
        (['gh', 'release', 'create', tag_name, f'--repo={REPO_NAME}', f'--title=Feuerwehr-Beitrag-Generator {tag_name}', '--generate-notes'],
